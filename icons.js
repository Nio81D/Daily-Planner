...
const DEFAULT_HABITS=Object.freeze([
  ...
  {id:'h-learning',label:'Career',target:5,color:PALETTE.coral,icon:'briefcase'},
  {id:'h-markets',label:'Markets & Investing',target:6,color:PALETTE.gold,icon:'trend-up'},
  {id:'h-mindfulness',label:'Mindfulness',target:5,color:PALETTE.purple,icon:'moon-stars'}
]);
...
{id:'t5',label:'Work',start:510,end:960,days:WEEKDAYS,color:PALETTE.coral,icon:'briefcase',habitId:'h-learning'},
