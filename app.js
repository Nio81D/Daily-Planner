...
{id:'t6',label:'Gym & Read',start:1020,end:1080,days:WEEKDAYS,color:PALETTE.green,icon:'barbell'},
{id:'t8',label:'Dinner',start:1080,end:1125,days:WEEKDAYS,color:PALETTE.blue,icon:'fork-knife'},
{id:'t9',label:'Study',start:1125,end:1230,days:[1],color:PALETTE.gold,icon:'book-open'},
{id:'t10',label:'Study',start:1125,end:1230,days:[2],color:PALETTE.gold,icon:'book-open'},
{id:'t11',label:'Study',start:1125,end:1230,days:[3],color:PALETTE.gold,icon:'book-open'},
{id:'t12',label:'Study',start:1125,end:1230,days:[4],color:PALETTE.gold,icon:'book-open'},
{id:'t13',label:'Study',start:1125,end:1230,days:[5],color:PALETTE.gold,icon:'book-open'},
{id:'t14',label:'Trade Journal',start:1230,end:1245,days:WEEKDAYS,color:PALETTE.gold,icon:'notebook'},
{id:'t15',label:'Wind Down: Read & Meditate',start:1245,end:1290,days:WEEKDAYS,color:PALETTE.gold,icon:'moon-stars'},
...
{id:'t18',label:'Gym & Read',start:480,end:630,days:[0],color:PALETTE.green,icon:'barbell'},
